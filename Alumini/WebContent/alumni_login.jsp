...
<h1 align="center">Welcome to Alumni Login Page</h1><br>
<div class="container-fulid">
		<div class="row justify-content-center align-items-center"
			...
			<div class="col-4">
				<div class="card">
					<div class="card-body">
						<form action="./alumni_login" method="post">
							...
							<br>
							<b>New Alumni?</b> <a href="alumni_register.jsp" class="btn btn-primary">Sign Up</a>
							</center>
						</form>
					</div>
				</div>
